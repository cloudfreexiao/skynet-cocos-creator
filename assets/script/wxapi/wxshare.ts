...
class WxShare
{
    ...
    share(params:WxShareParams, successCb?:handler, failCb?:handler)
    {
        wx.shareAppMessage({
            title:params.title,
    ...
    //截图并分享
    shareCanvas(params1:WxCaptureParams, params2:WxShareParams, canvas, successCb?:handler, failCb?:handler)
    {
    ...
    getShareInfo(shareTicket:string, successCb?:handler, failCb?:handler)
    {
        wx.getShareInfo({
            shareTicket,
            success: res => {
